...
> **الحالة: تاريخي (superseded) — التصميم الأولي 12 رئيسي + 24 فرعي = 36 وكيلًا.**
> النظام الفعلي اليوم: **100 رئيسي × 2 فرعي = 300 وكيل في 20 فرقة**
> (`node agents/index.js stats`). هذا المستند محفوظ كمرجع للتصميم الأولي فقط.
> **التاريخ:** 2026-09-10
