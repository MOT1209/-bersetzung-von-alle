...
export const MESSAGES = {
  ...
  'dub-lang-unsupported':  'الدبلجة غير متاحة لهذه اللغة — محرّك النطق لا يدعمها',
  'dub-failed':            'تعذّر توليد صوت الدبلجة — قد تكون الخدمة مزدحمة، حاول بعد قليل',
  ...
  // ===== فيديو/صوت محلي (مسار المشاريع — server/projectPipeline.js) =====
  'audio-empty':           'لم يُعثر على كلام واضح في الملف (موسيقى أو صمت فقط)',
  'alignment-failed':      'تعذّرت محاذاة الترجمة مع المقاطع الزمنية — حاول لاحقًا',
  'invalid-asset':         'الملف غير صالح أو صيغته غير مدعومة',
