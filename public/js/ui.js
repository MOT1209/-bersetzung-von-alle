...
export const glossaryImportBtn    = $('glossary-import-btn');
export const glossaryImportInput  = $('glossary-import-input');
export const glossaryImportStatus = $('glossary-import-status');
export const glossaryLoadEn   = $('glossary-load-en');
export const glossaryLoadAr   = $('glossary-load-ar');
