...
// علامة ع ⇄ A: قوس أبيض علوي يمرّ بأعلى نقطة (256, 99) وقوس نيلي سفلي بأدنى نقطة
// (256, 413) — مركزا الأقواس (256, 231) و(256, 281) ونصف قطرهما 132 وسماكتهما 34.
const JOBS = [
  {
    ...
    out: [
      { file: 'public/icons/icon-512.png', size: 512, checks: [
        ...
        { x: 0.5, y: 0.194, color: [251, 250, 248] },  // قمة القوس الأبيض العلوي
        { x: 0.5, y: 0.807, color: [143, 171, 224] },  // قاع القوس النيلي السفلي
        { x: 0.5, y: 0.985, color: [28, 26, 23] },     // أسفل اللوح — لا حبر خارج العلامة
      ] },
      { file: 'public/icons/icon-192.png', size: 192, checks: [
        { x: 0.5, y: 0.194, color: [251, 250, 248] },
        { x: 0.5, y: 0.807, color: [143, 171, 224] },
      ] },
    ],
  },
  {
    ...
    out: [
      { file: 'public/icons/maskable-512.png', size: 512, checks: [
        { x: 0.5, y: 0.28, color: [251, 250, 248] },   // قمة القوس الأبيض (مقياس 0.72 حول المركز)
        { x: 0.5, y: 0.72, color: [143, 171, 224] },   // قاع القوس النيلي
      ] },
    ],
  },
  {
  ...
  },
  {
    ...
    out: [
      { file: 'extension/icons/icon16.png', size: 16, checks: [
        { x: 0.5, y: 0.886, color: [143, 171, 224] },  // القوس النيلي (مقياس 0.32) — الأوضح في 16px
      ] },
      { file: 'extension/icons/icon48.png', size: 48, checks: [
        { x: 0.5, y: 0.114, color: [251, 250, 248] },
        { x: 0.5, y: 0.886, color: [143, 171, 224] },
      ] },
