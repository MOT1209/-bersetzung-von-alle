...
function errAr(code) {
  const map = {
    ...
    'ffmpeg-missing': 'أداة معالجة الصوت (ffmpeg) غير مثبَّتة على الخادم.',
    'ffmpeg-timeout': 'تجاوزت معالجة الصوت المهلة — جرّب فيديو أقصر.',
    'ffmpeg-failed': 'تعذرت معالجة الصوت أو دمج الفيديو.',
  };
